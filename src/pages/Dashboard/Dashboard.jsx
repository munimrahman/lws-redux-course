      ...
      <div class="mx-auto max-w-7xl px-5 lg:px-0">
        <div class="px-3 md:lg:xl:px-40  py-20 bg-opacity-10">
          <div class="grid grid-cols-1 md:grid-cols-2  gap-6 p-8">
            <Link to={"/admin/videos"} class="dashboard-item-card">
              <svg
                fill="none"
                viewBox="0 0 24 24"
                stroke-width="1.5"
            ...
            <Link to={"/admin/assignments"} class="dashboard-item-card">
              <svg
            ...
            <Link to={"/admin/assignment-marks"} class="dashboard-item-card">
              <svg
                viewBox="0 0 24 24"
                stroke-width="1.5"
                stroke="currentColor"
